...
(function (factory) {
    ...
    $.widget('blueimp.fileupload', $.blueimp.fileupload, {
        ...
        options: {
            ...
            // The maximum file size of image that are to be displayed as preview:
            previewSourceMaxFileSize: 5000000, // 5MB
            // The maximum width of the preview image:
            previewMaxWidth: 80,
            // The maximum height of the preview image:
            previewMaxHeight: 80,
            // By default, preview image are displayed as canvas elements
            // if supported by the browser. Set the following option to false
            // to always display preview image as img elements:
